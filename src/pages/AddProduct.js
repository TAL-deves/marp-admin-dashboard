...
// import { getRequestHandler, patchRequestHandler, photoUploadRequestHandler, postRequestHandler, putRequestHandler } from '../apiHandler/customApiHandler';
...
//     handleAddPhoto(files); // Pass convertedFile instead of files
...
//     setShow(true);  
//     console.log("files response", singleImage);
...
//       //   url: 'https://marpapi.techanalyticaltd.com/admin/bucket/uploadsingleimage?uploadto=category',
//       //   headers: { 
